defmodule Fractals.ParserRegistry do
  ...
  The application that implements the parser should add the parser to the registry.  Register using tagged types like so:
  ...
  Fractals.ParserRegistry.add(:output, :png, PNGOutput.Parser)
  ```
  """
