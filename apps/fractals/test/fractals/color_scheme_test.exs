defmodule Fractals.ColorSchemeTest do
  ...
  describe "black on white" do
    test "colors outside" do
      params = %{Job.default() | color: %ColorScheme{type: :black_on_white}}
  ...
  describe "white on black" do
    test "colors outside" do
      params = %{Job.default() | color: %ColorScheme{type: :white_on_black}}
  ...
  describe "gray" do
    test "black inside" do
      params = %{Job.default() | color: %ColorScheme{type: :gray}}
      assert ColorScheme.color_point({nil, 512}, params) == Color.rgb(:black)
    end
  ...
  describe "Warp POV" do
    test "red" do
      params = %{Job.default() | color: %ColorScheme{type: :red}}
      assert ColorScheme.color_point({nil, 128}, params) == Color.rgb(1.0, 0.0, 0.0)
    end

    test "green" do
      params = %{Job.default() | color: %ColorScheme{type: :green}}
      assert ColorScheme.color_point({nil, 128}, params) == Color.rgb(0.0, 1.0, 0.0)
    end

    test "blue" do
      params = %{Job.default() | color: %ColorScheme{type: :blue}}
